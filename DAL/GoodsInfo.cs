...
namespace DAL
{
	...
	public partial class GoodsInfo
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Model.GoodsInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into GoodsInfo(");
			strSql.Append("goods,porter,outtime,returntime)");
			strSql.Append(" values (");
			strSql.Append("@goods,@porter,@outtime,@returntime)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@goods", SqlDbType.VarChar,50),
					new SqlParameter("@porter", SqlDbType.VarChar,50),
			...
			parameters[1].Value = model.porter;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Model.GoodsInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update GoodsInfo set ");
			strSql.Append("goods=@goods,");
			strSql.Append("porter=@porter,");
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.GoodsInfo GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,goods,porter,outtime,returntime from GoodsInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Model.GoodsInfo model=new Model.GoodsInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.GoodsInfo DataRowToModel(DataRow row)
		{
			Model.GoodsInfo model=new Model.GoodsInfo();
			if (row != null)
			{
				...
				if(row["porter"]!=null)
				{
					model.porter=row["porter"].ToString();
				}
				if(row["outtime"]!=null)
				{
					model.outtime=row["outtime"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,goods,porter,outtime,returntime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,goods,porter,outtime,returntime ");
			strSql.Append(" FROM GoodsInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
